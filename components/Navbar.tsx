  ...
  return isMobile ? (
    ...
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit  fixed top-10 inset-x-0 mx-auto border bg-black-100 border-white/[0.2] rounded-full shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-2 pl-8 py-2 items-center justify-center space-x-4 bg-black-100",
          className
        )}
      >
        {navItems.map((navItem: any, idx: number) => (
